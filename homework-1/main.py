...
serverPort = 8010 # Порт для доступа по сети
        ...
        <main class="row">
            <div class="row text-center">
                <div class="col-15">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <div class="card-header py-3">
                            <h4 class="my-3 fw-normal">FAQ</h4>
                            <p>
                                <a class="btn btn-info" data-bs-toggle="collapse" href="#multiCollapseExample1"
                                   role="button" aria-expanded="false" aria-controls="multiCollapseExample1">Как
                                    купить?</a>
                                ...
                                <div class="col">
                                    <div class="collapse multi-collapse" id="multiCollapseExample1">
                                        <div class="card card-body">
                                            С помощью СПБ (системы быстрых платежей)
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="collapse multi-collapse" id="multiCollapseExample2">
                                        <div class="card card-body">
                                            После оплаты заказа, мы с вами свяжемся для уточнения адреса.
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="collapse multi-collapse" id="multiCollapseExample3">
                                        <div class="card card-body">
                                             Зависит от каждого отдельного товара (от 3 до 36 месяцев)
                                        </div>
                                    </div>
                                </div>
                            </div>
